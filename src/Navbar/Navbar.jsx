      ...
      <nav className="">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex md:items-center md:space-x-4">
              ...
              <a href="#services" className="text-white hover:text-gray-700 px-3 py-2 rounded-md text-sm font-medium">Services</a>
        ...
        <div className={`${isOpen ? "block" : "hidden"} md:hidden`}>
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <a href="/projects" className="text-white hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-sm font-medium">Home</a>
